...
Up_Body_App는 사용자의 신체 정보와 활동 데이터를 기반으로 건강 상태를 분석하고, GPT 기반 AI 미션을 생성하여 운동 습관 형성을 돕는 캡스톤 디자인 프로젝트입니다.  
...
Up_Body_AppI는 이 문제를 해결하기 위해 다음 흐름을 제공합니다.
...
Up_Body_App에서 GPT는 자유롭게 미션을 만드는 생성기가 아니라, 서버 규칙 안에서 동작하는 구조화 생성기로 사용됩니다.
...
Up_Body_App는 건강 데이터와 게임 데이터를 분리하여 관리합니다.
